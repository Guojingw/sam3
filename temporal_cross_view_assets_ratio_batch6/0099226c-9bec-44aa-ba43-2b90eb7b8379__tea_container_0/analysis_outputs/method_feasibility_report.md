...
- Case: `0099226c-9bec-44aa-ba43-2b90eb7b8379__tea_container_0`
- Target object: `tea container_0`
- Analysis status: **success**
- Source reference: `aria01_214-1` frame `1320`
- Source mask area ratio: `0.04108876630294422`
...
- Confidence: `0.7`
- Selection reason: The container is present in the left-lower work area through the segment and is distinct from the person and stove hardware.
- Recommended SAM3 prompt: `Seed on the red container body in the left-lower quadrant; avoid nearby tiles and the person at the stove.`
...
- Stable normalized region: `[0.13, 0.58, 0.31, 0.84]`
- Position drift: `low`
- Scale change: `low`
- Explanation: Estimated box around the tea container based on the authoritative source mask overlay and the recurring lower-half working-area placement across the selected segment.
