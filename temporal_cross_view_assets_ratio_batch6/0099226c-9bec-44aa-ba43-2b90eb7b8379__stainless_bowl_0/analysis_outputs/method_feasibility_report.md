...
- Case: `0099226c-9bec-44aa-ba43-2b90eb7b8379__stainless_bowl_0`
- Target object: `stainless bowl_0`
- Analysis status: **success**
- Source reference: `aria01_214-1` frame `3450`
- Source mask area ratio: `0.03918709242639463`
...
- Confidence: `0.77`
- Selection reason: The bowl stays present near the stove across the whole interval, with only brief hand occlusion and stable placement for propagation.
- Recommended SAM3 prompt: `Initialize on the metal bowl body on the stove; avoid the person and use the rim as the seed region.`
...
- Stable normalized region: `[0.35, 0.45, 0.54, 0.66]`
- Position drift: `low`
- Scale change: `low`
- Explanation: Estimated box around the stainless bowl based on the authoritative source mask overlay and the recurring lower-half working-area placement across the selected segment.
